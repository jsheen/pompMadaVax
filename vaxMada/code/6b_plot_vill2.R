...
load(file=paste0("~/vaxMada-data/objects/data_obj/mcap_res_beta_vill2.RData"))
...
#save(sims, file=paste0("~/vaxMada-data/objects/data_obj/esims_vill2.RData"))
#save(sims_confint, file=paste0("~/vaxMada-data/objects/data_obj/esims_confint_vill2.RData"))
#load(file=paste0("~/vaxMada-data/objects/data_obj/sims_vill2.RData"))
