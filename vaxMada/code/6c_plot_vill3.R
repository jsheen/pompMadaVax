...
load(file=paste0("~/vaxMada-data/objects/data_obj/mcap_res_beta_vill3.RData"))
...
#save(sims, file=paste0("~/vaxMada-data/objects/data_obj/esims_vill3.RData"))
#save(sims_confint, file=paste0("~/vaxMada-data/objects/data_obj/esims_confint_vill3.RData"))
load(file=paste0("~/vaxMada-data/objects/data_obj/sims_vill3.RData"))
