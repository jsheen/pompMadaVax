...
library(doFuture)
library(tidyverse)
load("~/vaxMada-data/objects/data_obj/saha/hh_data.RData")
load("~/vaxMada-data/objects/data_obj/saha/sums.RData")
...
new_row$deaths <- round((18 + 40) / 2)
new_row$denoms <- round((184 + 146) /2)
...
save(data, file="~/vaxMada-data/objects/data_obj/data_vill3.RData")
