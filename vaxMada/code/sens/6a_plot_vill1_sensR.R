...
load(file=paste0("~/vaxMada-data/objects/data_obj/mcap_res_beta_sensR.RData"))
...
save(sims, file=paste0("~/vaxMada-data/objects/data_obj/sims_sensR.RData"))
save(sims_confint, file=paste0("~/vaxMada-data/objects/data_obj/sims_confint_sensR.RData"))
