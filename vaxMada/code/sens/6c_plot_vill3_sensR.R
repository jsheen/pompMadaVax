...
load(file=paste0("~/vaxMada-data/objects/data_obj/p_beta_vill3_sensR.RData"))
load(file=paste0("~/vaxMada-data/objects/data_obj/mcap_res_beta_vill3_sensR.RData"))
...
sir_rinit <- function (...) {
  c(cnt=1, f_size = 0, rt=0, r0=0, eta=0, eta_best=0, S = 366, I = 21, V_S=0, V_I=0, R = 61, D=2, H = 2, W=0)
}
...
save(sims, file=paste0("~/vaxMada-data/objects/data_obj/sims_vill3_sensR.RData"))
save(sims_confint, file=paste0("~/vaxMada-data/objects/data_obj/sims_confint_vill3_sensR.RData"))
#load(file=paste0("~/vaxMada-data/objects/data_obj/sims_vill3_sensR.RData"))
#load(file=paste0("~/vaxMada-data/objects/data_obj/sims_confint_vill3_sensR.RData"))
