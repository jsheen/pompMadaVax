...
import_input <- 1 / 10 # 5 infectious import per month on average
...
save(p_beta, file=paste0("~/vaxMada-data/objects/data_obj/p_beta_sensL.RData"))
save(mcap_res_beta, file="~/vaxMada-data/objects/data_obj/mcap_res_beta_sensL.RData")

# Estimate psi using post-vaccination data
load(file=paste0("~/vaxMada-data/objects/data_obj/p_beta_sensL.RData"))
load(file="~/vaxMada-data/objects/data_obj/mcap_res_beta_sensL.RData")
best_beta <- p_beta$Beta[which.max(p_beta$loglik)]
...
(1 - best_psi) * 0.95
#save(p_psi, file=paste0("~/vaxMada-data/objects/data_obj/p_psi_sensL.RData"))
#save(mcap_res_psi, file=paste0("~/vaxMada-data/objects/data_obj/mcap_res_psi_sensL.RData"))
