...
load(file=paste0("~/vaxMada-data/objects/data_obj/p_beta_vill2_sensR.RData"))
load(file=paste0("~/vaxMada-data/objects/data_obj/mcap_res_beta_vill2_sensR.RData"))
...
save(sims, file=paste0("~/vaxMada-data/objects/data_obj/sims_vill2_sensR.RData"))
save(sims_confint, file=paste0("~/vaxMada-data/objects/data_obj/sims_confint_vill2_sensR.RData"))
#load(file=paste0("~/vaxMada-data/objects/data_obj/sims_vill2_sensR.RData"))
#load(file=paste0("~/vaxMada-data/objects/data_obj/sims_confint_vill2_sensR.RData"))
