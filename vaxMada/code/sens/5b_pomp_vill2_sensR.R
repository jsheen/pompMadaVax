...
#save(p_beta, file=paste0("~/vaxMada-data/objects/data_obj/p_beta_coarse_vill2_sensR.RData"))
#save(mcap_res_beta, file="~/vaxMada-data/objects/data_obj/mcap_res_beta_coarse_vill2_sensR.RData")
...
save(p_beta, file=paste0("~/vaxMada-data/objects/data_obj/p_beta_vill2_sensR.RData"))
save(mcap_res_beta, file="~/vaxMada-data/objects/data_obj/mcap_res_beta_vill2_sensR.RData")
