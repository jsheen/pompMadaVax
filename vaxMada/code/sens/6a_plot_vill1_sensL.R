...
load(file=paste0("~/vaxMada-data/objects/data_obj/p_beta_sensL.RData"))
load(file=paste0("~/vaxMada-data/objects/data_obj/mcap_res_beta_sensL.RData"))
...
save(sims, file=paste0("~/vaxMada-data/objects/data_obj/sims_sensL.RData"))
save(sims_confint, file=paste0("~/vaxMada-data/objects/data_obj/sims_confint_sensL.RData"))
#load(file=paste0("~/vaxMada-data/objects/data_obj/sims.RData"))
...
#save(sims2, file=paste0("~/vaxMada-data/objects/data_obj/sims2_sensL.RData"))
#save(sims_confint2, file=paste0("~/vaxMada-data/objects/data_obj/sims_confint2_sensL.RData"))
...
png(filename="~/vaxMada-data/plots/Rt_vill1.png", 
    width = 8,
    height = 8,
    units = "in",
    res = 400)
plot_grid(suscep, Rt, cases, align = "v", nrow = 3, rel_heights = c(3/10, 3/10, 4/10))
dev.off()
...
save(HI_confints, file="~/vaxMada-data/objects/data_obj/HI_confints_sensL.RData")
