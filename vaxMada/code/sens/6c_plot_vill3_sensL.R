...
load(file=paste0("~/vaxMada-data/objects/data_obj/p_beta_vill3_sensL.RData"))
load(file=paste0("~/vaxMada-data/objects/data_obj/mcap_res_beta_vill3_sensL.RData"))
...
#save(sims, file=paste0("~/vaxMada-data/objects/data_obj/sims_vill3_sensL.RData"))
#save(sims_confint, file=paste0("~/vaxMada-data/objects/data_obj/sims_confint_vill3_sensL.RData"))
load(file=paste0("~/vaxMada-data/objects/data_obj/sims_vill3_sensL.RData"))
load(file=paste0("~/vaxMada-data/objects/data_obj/sims_confint_vill3_sensL.RData"))
