...
rho_input <- 0.8 # 80% reporting rate of deaths
...
save(p_beta, file=paste0("~/vaxMada-data/objects/data_obj/p_beta_vill3_sensR.RData"))
save(mcap_res_beta, file="~/vaxMada-data/objects/data_obj/mcap_res_beta_vill3_sensR.RData")
