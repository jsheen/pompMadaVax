...
#save(p_beta, file=paste0("~/vaxMada-data/objects/data_obj/p_beta_coarse.RData"))
#save(mcap_res_beta, file="~/vaxMada-data/objects/data_obj/mcap_res_beta_coarse.RData")
...
#save(p_beta, file=paste0("~/vaxMada-data/objects/data_obj/p_beta.RData"))
#save(mcap_res_beta, file="~/vaxMada-data/objects/data_obj/mcap_res_beta.RData")
...
(1 - best_psi) * 0.95
#save(p_psi, file=paste0("~/vaxMada-data/objects/data_obj/p_psi.RData"))
#save(mcap_res_psi, file=paste0("~/vaxMada-data/objects/data_obj/mcap_res_psi.RData"))
